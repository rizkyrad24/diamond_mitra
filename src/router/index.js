...
const routes = [
  ...
  { name: 'MasukManager', path: '/masukmanager', component: MasukManager, meta: { requiresAuth: true, role: ['PartnershipManager'] }  },
  { name: 'DetailPengajuanManager', path: '/masukmanager/detailpengajuanmanager/:base/:id', component: DetailPengajuanManager, meta: { requiresAuth: true, role: ['PartnershipManager'] }  },
