  ...
  <ModalFailed :isVisible="modalFailed.isVisible" :title="modalFailed.title" :message="modalFailed.message"
    ...
    <div v-if="showFormPopup" class="fixed inset-0 flex items-center justify-center bg-[#1F2937] bg-opacity-50">
      <div class="w-[684.92px] rounded-lg shadow-lg bg-[#FFFFFF] border-collapse pb-12">
        ...
        <h1 class="font-sans text-[30px] text-center text-[#333333] mt-6 ml-[5px] font-semibold">Create User</h1>
        <div class="w-full h-[400px] overflow-y-auto px-10 pb-5">
          <div class="mb-4">
            ...
            <form action="" class="w-full py-[10px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between">
              <input type="text" placeholder="Username..." class="w-full outline-none">
            </form>
          </div>
          <div class="mb-4">
            <label class="text-[#4D5E80] font-medium">First Name <span class="text-[#FF5656]">*</span></label>
            <form action="" class="w-full py-[10px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between">
              <input type="text" placeholder="First Name..." class="w-full outline-none">
            </form>
          </div>
          <div class="mb-4">
            <label class="text-[#4D5E80] font-medium">Last Name </label>
            <form action="" class="w-full py-[10px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between">
              <input type="text" placeholder="Last Name..." class="w-full outline-none">
            </form>
          </div>
          <div class="mb-4">
            <label class="text-[#4D5E80] font-medium">Email </label>
            <form action="" class="w-full py-[10px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between">
          ...
          <div class="mb-4">
            <label class="text-[#4D5E80] font-medium">Email </label>
            <form action="" class="w-full py-[10px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between">
              <select class="w-full outline-none px-2">
          ...
          <div class="flex justify-center mt-8">
            <button class="p-3 flex justify-center bg-[#2671D9] w-full hover:bg-[#1E5BB7] rounded-lg border-[1px] text-[#FFFFFF] text-[16px] text-center font-sans font-semibold">
              Create User
            </button>
          </div>
        </div>
              ...
              <tr v-for="(item, index) in filteredAndPaginatedData" :key="`${index}-${item.username}`"
                ...
                <td class="p-2 py-4 border border-[#E5E7E9] relative">
                  ...
                  <div v-if="actionDropdownIndex === index" class="absolute right-0 mt-2 w-[160px] rounded-lg bg-[#FFFFFF] border border-[#E5E7E9] shadow-lg z-10">
                    <button @click="() => null" class="block w-full flex-grow px-4 py-2 text-[14px] font-sans font-normal text-[#333333] text-left hover:bg-[#DBEAFE]">Edit</button>
                    <button @click="() => null" class="block w-full flex-grow px-4 py-2 text-[14px] font-sans font-normal text-[#333333] text-left hover:bg-[#DBEAFE]">Delete</button>
                  </div>
                </td>
              </tr>
            </tbody>
