      ...
      <div class="w-auto h-[404px] bg-[#FFFFFF] mt-[48px]">
        ...
        <div class="w-[480px] h-[168px] bg-[#FFFFFF] mt-8">
          <div class="flex flex-col w-[480px] h-[72px] bg-[#FFFFFF]">
            ...
            <input type="text" v-model="username" placeholder="Masukkan username" class="w-[480px] h-[40px] rounded-md bg-[#FFFFFF] border border-[#E5E7E9] mt-2 pl-4 font-sans font-normal text-[14px] text-[#7F7F80] outline-none" />
          </div>
          ...
          <div class="relative w-[480px] h-[112px] bg-[#FFFFFF] mt-8">
            <button @click="submit" :disabled="isDisableLogin" :class="isDisableLogin? 'bg-[#9C9C9C] text-white': 'bg-[#2671D9] hover:bg-[#1E5BB7]'" class="w-[480px] h-[48px] rounded-md text-[#FFFFFF] font-sans font-medium text-[14px]">Login</button>
