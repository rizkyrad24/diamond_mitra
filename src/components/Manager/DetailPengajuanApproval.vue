      ...
      <div class="relative h-auto w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
        ...
        <!-- <div v-if="showApprovalPopup" class="fixed inset-0 flex items-center justify-center bg-[#1F2937] bg-opacity-50">
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[360px] h-[500px]">
            <button @click="closeApprovalPopup"
              class="text-[#4B5563] absolute mt-2 ml-[330px] text-[20px]">&times;</button>
            <div class="flex flex-col justify-center items-center mt-14 ml-8 mr-8 mb-14">
              <svg width="200" height="160" viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M36.1789 41.25L30.6023 44.357L36.1789 47.464L36.1789 41.25ZM35.4354 42.4928L32.0894 44.357L35.4354 46.2212L35.4354 42.4928Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M3.48554 60.45L3.87176 66.6528L9.24518 63.2286L3.48554 60.45ZM4.30499 61.6475L4.53672 65.3692L7.76077 63.3147L4.30499 61.6475Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M162.53 110.221L156.283 108.714L158.054 114.688L162.53 110.221ZM161.1 110.615L157.352 109.711L158.415 113.296L161.1 110.615Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M193.37 104.821L195.559 98.9772L189.22 100.07L193.37 104.821ZM193.108 103.408L194.422 99.902L190.618 100.557L193.108 103.408Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M96.4597 152.061L90.2127 150.554L91.9837 156.528L96.4597 152.061ZM95.03 152.456L91.2818 151.552L92.3444 155.136L95.03 152.456Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M158.774 133.256L157.503 127.164L152.671 131.273L158.774 133.256ZM157.791 132.179L157.028 128.524L154.129 130.989L157.791 132.179Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M142.866 35.2697L148.402 32.0963L142.786 29.0562L142.866 35.2697ZM143.593 34.0181L146.915 32.1141L143.546 30.29L143.593 34.0181Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M43.9449 132.324L47.3912 137.573L50.3787 132.068L43.9449 132.324ZM45.2622 132.99L47.3301 136.139L49.1225 132.836L45.2622 132.99Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M161.425 71.3339L164.872 76.583L167.859 71.0782L161.425 71.3339ZM162.743 71.9997L164.81 75.1492L166.603 71.8463L162.743 71.9997Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M188.53 56.5204L194.841 55.2857L190.578 50.6289L188.53 56.5204ZM189.645 55.5702L193.431 54.8294L190.873 52.0353L189.645 55.5702Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M92.4667 7.90306L97.6665 15.8229L102.174 7.5173L92.4667 7.90306ZM94.4543 8.90761L97.5742 13.6595L100.279 8.67615L94.4543 8.90761Z"
                  fill="#CCCCCC" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M79.7763 144.536L78.7893 148.14L82.5177 147.163L79.7763 144.536ZM80.1662 145.92L79.8372 147.122L81.08 146.796L80.1662 145.92Z"
                  fill="#CCCCCC" />
              ...
              <p class="text-[16px] font-sans text-[#333333] font-normal mb-6 text-center">Apakah Anda yakin ingin
                menyetujui pengajuan ini? Proses pengajuan kemitraan akan diselesaikan.</p>
              <button @click="approvePengajuan"
                class="bg-[#2671D9] hover:bg-[#1E5BB7] text-[#FFFFFF] text-[14px] font-semibold p-2 rounded-lg w-full mb-2">Setujui</button>
              <button @click="closeApprovalPopup" class="absolute flex mt-[395px]">
                <div
                  class="flex items-center justify-center w-[296px] h-[40px] rounded-lg bg-[#FFFFFF] border-[#2671D9] border-[1px] hover:bg-[#DBEAFE] cursor-pointer transition-all">
                  <span
                    class="text-[14px] font-sans font-medium text-[#2671D9] ml-3 mt-[9px] mr-3 mb-[9px]">Batal</span>
                </div>
              </button>
            </div>
          </div>
        ...
        <!-- <div v-if="showDisetujuiPopup"
          ...
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[360px] h-[476px]">
            <div class="flex flex-col items-center mt-14 ml-8 mr-8 mb-14">
              ...
              <p class="text-[16px] font-sans text-[#333333] font-normal mb-6 text-center">Anda telah berhasil
                menyetujui pengajuan ini. Proses pengajuan kemitraan telah selesai. Silakan cek pengajuan pada menu
                Selesai.</p>
              <button @click="closeDisetujuiPopup"
                class="bg-[#2671D9] hover:bg-[#1E5BB7] text-[#FFFFFF] text-[14px] p-2 rounded-lg w-full">Selesai</button>
            </div>
          </div>
        </div> -->
      </div>
